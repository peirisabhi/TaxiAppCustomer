package com.zonebecreations.taxiappcustomer.ui.signUp;
...
//    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        signUpFragmentBinding.textView2.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        signUpFragmentBinding.authGoogle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                createSignInIntent();
            }
        ...
        signUpFragmentBinding.btnNxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavDirections navDirections = SignUpFragmentDirections.actionSignUpFragmentToSignUpDetailsFragment();
//                navDirections.getArguments().putString("email", "asas0");
//                navDirections.getArguments().putString("name", "212121");
                Navigation.findNavController(view).navigate(navDirections);
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                NavDirections navDirections = SignUpFragmentDirections.actionSignUpFragmentToSignUpDetailsFragment();
                Navigation.findNavController(signUpFragmentBinding.getRoot()).navigate(navDirections);
